...
//Array que almacena los precios de los productos
const sumaFactura = [];
console.log(sumaFactura)
//Suma los números en el array 
let total=0
function array (){
  for(let i = 0; i < sumaFactura.length; i++) total+=sumaFactura[i];
  document.getElementById("total").innerHTML = "¡Muchas gracias por visitarnos! <br> El total de su compra es $"+total;
}  

//Limpiar resumen de orden

function eliminarPago (){
    window.location.reload()
}
//Resumen de orden & Botones
